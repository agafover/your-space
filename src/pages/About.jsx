...
function About() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 text-center">
      <h1 className="text-4xl font-extrabold text-brand-dark dark:text-brand-light mb-6">
        О нас
      </h1>

      <p className="text-lg text-brand-text dark:text-gray-300 mb-4">
        Мы — женское сообщество для самовыражения, поддержки и вдохновения.
      </p>

      <p className="text-lg text-brand-text dark:text-gray-300 mb-6">
